...
/**
 * Integration tests for {@link TagsController}.
 */
@Sql(scripts = "/sql/setup_TagsControllerIT.sql", executionPhase = BEFORE_TEST_METHOD)
@Sql(scripts = "/sql/cleanup.sql", executionPhase = AFTER_TEST_METHOD)
@SuppressWarnings("checkstyle:magicnumber")
public class TagsControllerIT extends ControllerIT {
